...
# osx.sh — Forked from https://mths.be/macos
...
defaults write NSGlobalDomain AppleLanguages -array "en" "es" "ca"
...
# Invert the Magic Trackpad orientation
...
for app in "Activity Monitor" "cfprefsd" "Dock" "Finder" "Google Chrome" \
        "Photos" "Safari" "SystemUIServer" "Terminal" "Transmission"; do
